...
const VerifyVendorEmail = () => {
    ...
    const handleVerifyEmail = async () => {
        try {
            const response = await axios.post('https://unibackend-4ebp.onrender.com/api/v1/vendor/verify-email', { otp },);
    ...
    const handleresendEmail = async () => {
        try {
            ...
            const response = await axios.post('https://unibackend-4ebp.onrender.com/api/v1/vendor/resend-otp', null, headers);
            setApiResponse(response.data);
