...
const VendorResetPassword: React.FC<ResetPasswordProps> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.put("https://unibackend-4ebp.onrender.com/api/v1/vendor/update-password", {
        resetOtp,
        newPassword,
        confirmPassword,
      });
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex justify-center items-center bg-black/50 p-2 md:p-0">
          <div className="bg-white shadow-2xl rounded-[20px] p-4 flex flex-col gap-4 justify-center items-center">
            ...
            <a href='/loginVendor' className="text-[17px] text-center md:w-[80%] w-[90%]" style={{color: '#590209', fontWeight: 'bolder'}}>
