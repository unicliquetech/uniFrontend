...
const AddProductModal: React.FC<AddProductModalProps> = ({ isOpen, onRequestClose }) => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        // Here, you can perform the necessary actions to save the product details
                            ...
                            <div>
                                ...
                                <div className="mb-4">
                                    ...
                                    >
                                        ...
                                        <option value="apple">Apple / MacBooks</option>
                ...
                (color) => (
                  <button
                    ...
                    className={`h-8 w-8 rounded-full mr-2 ${
                      colors.includes(color) ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
